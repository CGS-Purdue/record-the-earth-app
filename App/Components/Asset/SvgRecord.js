    ...
    return (
      <View style={SvgContainerStyles}>
        ...
        <G transform="translate(-3.63 -534.22)">
          ...
          <Path d="M230.65 550.84a228.2 228.2 0 0 0-69.07 10.9c-46.36 14.99-85.24 52.45-95.64 92.17-12.3 46.72 48.12 49.05 168.72 41.42 38.04-2.4 84.48-17.4 126.92-14.1 15.16 1.18 33.64 16.47 45.64 6.85 5.07-4.07 4.57-13.22 1.36-19.45-23.85-45.48-55.34-88.99-110.5-107.36-21.11-7.03-44.14-10.5-67.43-10.43z" fill="url(#f)" stroke="#670000"/>
          <Text y="810.5" x="93.09" style="line-height:1.25" font-weight="400" font-size="133.33" font-family="sans-serif" letter-spacing="0" word-spacing="0">
            <Tspan y="810.5" x="93.09" fill="#fff">REC</Tspan>
          </Text>
        </G>
      </Svg>
    </View>
