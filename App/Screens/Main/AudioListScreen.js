...
class ConfigView extends React.Component {
  ...
  _renderItem = ({ item }) => {
    if (item.type === 'color') {
      ...
      return (
        <SectionContent>
          <Text style={AudioListScreenStyles.sectionContentText}>
            {item.value}
          </Text>
        </SectionContent>
      );
  ...
  return (
    <View style={AudioListScreenStyles.titleContainer}>
      ...
      <View style={AudioListScreenStyles.titleTextContainer}>
        ...
        <Text style={AudioListScreenStyles.descriptionText}>
...
const SectionContent = (props) => {
  return (
    <View style={AudioListScreenStyles.sectionContentContainer}>
      {props.children}
    </View>
  );
};
  ...
  if (!value) {
    ...
    return (
      <View style={AudioListScreenStyles.colorContainer}>
        <View
          style={[
            AudioListScreenStyles.colorPreview,
